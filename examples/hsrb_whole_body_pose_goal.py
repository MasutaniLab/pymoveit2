...
- ros2 run pymoveit2 hsrb_whole_body_pose_goal.py --ros-args -p position:="[0.25, 0.0, 1.0]" -p quat_xyzw:="[0.0, 0.0, 0.0, 1.0]" -p cartesian:=False
- ros2 run pymoveit2 hsrb_whole_body_pose_goal.py --ros-args -p position:="[0.25, 0.0, 1.0]" -p quat_xyzw:="[0.0, 0.0, 0.0, 1.0]" -p cartesian:=False -p synchronous:=False -p cancel_after_secs:=1.0
- ros2 run pymoveit2 hsrb_whole_body_pose_goal.py --ros-args -p position:="[0.25, 0.0, 1.0]" -p quat_xyzw:="[0.0, 0.0, 0.0, 1.0]" -p cartesian:=False -p synchronous:=False -p cancel_after_secs:=0.0
"""
...
from pymoveit2.robots import hsrb
...
def main():
    ...
    moveit2 = MoveIt2(
        node=node,
        joint_names=hsrb.whole_body_joint_names(),
        base_link_name=hsrb.base_link_name(),
        end_effector_name=hsrb.end_effector_name(),
        group_name=hsrb.MOVE_GROUP_WHOLE_BODY,
